...
<div class="container mx-auto px-4 py-8">
    <div class="mb-6">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('tutor.learning-history.index') }}" 
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="mt-6 bg-white rounded-lg shadow overflow-hidden">
                ...
                <div class="p-6">
                    <div class="flex items-center justify-between">
                        ...
                        <a href="{{ Storage::disk('public')->url($session->material) }}" 
                           target="_blank"
        ...
        <div class="lg:col-span-1">
            ...
            <div class="bg-white rounded-lg shadow overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-200">
                    <h2 class="text-xl font-semibold text-gray-900">Informasi Student</h2>
                </div>
                <div class="p-6">
                    <div class="flex items-center">
            ...
            <div class="mt-6 bg-white rounded-lg shadow overflow-hidden">
                ...
                <div class="p-6">
                    <dl class="space-y-4">
                        ...
                        @endif
                        @if($session->payment->verified_by)
                        <div>
                            <dt class="text-sm font-medium text-gray-500">Diverifikasi Oleh</dt>
                            <dd class="mt-1 text-sm text-gray-900">
                                @php
                                    $verifier = \App\Models\User::find($session->payment->verified_by);
                                @endphp
