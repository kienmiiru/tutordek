                ...
                <div class="mb-6">
                    ...
                    <div class="mt-2 space-y-2">
                        <div class="flex items-center">
                            <input id="role_student" type="radio" name="role" value="student"
                                {{ old('role') == 'student' ? 'checked' : '' }}
                                class="h-4 w-4 text-indigo-600 focus:ring-indigo-500">
                            <label for="role_student" class="ml-3 block text-sm font-medium text-gray-700">Siswa</label>
                        </div>
                        <div class="flex items-center">
                            <input id="role_tutor" type="radio" name="role" value="tutor"
