...
<div class="fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-lg">
    ...
    <nav class="mt-8">
        <div class="px-4 space-y-2">
            ...
            <a href="{{ route('admin.payment-methods.index') }}" class="flex items-center px-4 py-2 text-gray-700 bg-blue-100 rounded-lg">
...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow">
        <div class="px-6 py-4 border-b border-gray-200">
            <h3 class="text-lg font-medium text-gray-900">Payment Method Configuration</h3>
            <p class="text-sm text-gray-600 mt-1">Configure the payment method that will be displayed to students</p>
        </div>
        <div class="p-6">
            <form action="{{ route('admin.payment-methods.update') }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <textarea 
                        ...
                        placeholder="Enter payment method details (e.g., bank transfer information, digital wallet details, etc.)"
                    >{{ $paymentMethod ? $paymentMethod->payment_method : '' }}</textarea>
                    <p class="text-sm text-gray-500 mt-1">
                        This information will be displayed to students when they need to make payments for tutoring sessions.
                    </p>
                </div>
